...
def crear_vehiculo(request):
    if request.method == 'POST':
        ...
        if formulario.is_valid():
            ...
            vehiculo = autos(nombre=datos_formulario['nombre'], nombre_del_auto=datos_formulario['nombre_del_auto'],
                kilometros_recorridos=datos_formulario['kilometros_recorridos'], detalles_auto=datos_formulario['detalles_auto'])
            vehiculo.save()
